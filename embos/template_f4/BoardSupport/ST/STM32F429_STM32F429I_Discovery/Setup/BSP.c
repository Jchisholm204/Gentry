...
#define RCC_AHB1ENR        (*(volatile unsigned int*)(RCC_BASE_ADDR + 0x30u))
...
#define LED0_BIT           (13)  // LED3 (green) - PG13
#define LED1_BIT           (14)  // LED4 (red)   - PG14
