ReadMe.txt for the ST STM32F401 start project.

This project was built for emIDE V2.20.

Supported hardware:
===================
The sample project for the ST STM32F401 is prepared to run on
a ST STM32F401xC-Discovery eval board. Using different target
