...
void SetSysClock(void) {
  ...
  // Configure PLL1
  //
  RCC->PLL1CFGR = (2u << RCC_PLL1CFGR_PLL1SRC_Pos)    // Select HSI as input source
  ...
  RCC->PLL1DIVR = (9u << RCC_PLL1DIVR_PLL1N_Pos)      // Set PLL1 multiplier to 10
                | (1u << RCC_PLL1DIVR_PLL1P_Pos)      // Set PLL1P to allowed value
                | (1u << RCC_PLL1DIVR_PLL1Q_Pos)      // Set PLL1Q to allowed value
                | (0u << RCC_PLL1DIVR_PLL1R_Pos);     // Bypass PLL1R divider
