...
#define USART_BASE_ADDR       (0x40004800u)  // USART3
...
static void _SetBaudrate(unsigned int Unit, unsigned long Baudrate) {
  ...
  if (Unit == 0) {
    ...
    USART_BRR = BSP_UART_CLOCK / Baudrate / 4;  // Set baudrate.
    if (bWasEnabled == 1) {
