    ...
    *--pStartPacket = (U8)EventId;
    ...
    if (EventId < 127) {
      *--pStartPacket = (U8)EventId;
      ...
      // Backwards U32 encode EventId.
      //
      unsigned long LongEventId;

      LongEventId = (unsigned long)EventId;
      if (LongEventId < (1u << 14)) { // Encodes in 2 bytes
        *--pStartPacket = (U8)(LongEventId >>  7);
        *--pStartPacket = (U8)(LongEventId | 0x80);
      } else if (LongEventId < (1ul << 21)) {    // Encodes in 3 bytes
        *--pStartPacket = (U8)(LongEventId >> 14);
        *--pStartPacket = (U8)((LongEventId >>  7) | 0x80);
        *--pStartPacket = (U8)(LongEventId | 0x80);
      } else if (LongEventId < (1ul << 28)) {    // Encodes in 4 bytes
        *--pStartPacket = (U8)(LongEventId >> 21);
        *--pStartPacket = (U8)((LongEventId >> 14) | 0x80);
        *--pStartPacket = (U8)((LongEventId >>  7) | 0x80);
        *--pStartPacket = (U8)(LongEventId | 0x80);
      } else {                              // Encodes in 5 bytes
        *--pStartPacket = (U8)(LongEventId >> 28);
        *--pStartPacket = (U8)((LongEventId >> 21) | 0x80);
        *--pStartPacket = (U8)((LongEventId >> 14) | 0x80);
        *--pStartPacket = (U8)((LongEventId >>  7) | 0x80);
        *--pStartPacket = (U8)(LongEventId | 0x80);
      }
