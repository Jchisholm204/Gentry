...
Supported hardware:
===================
The sample projects for the ST STM32F103 are prepared
to run on a ST STM3210E-Eval board. Using different target
...
- Debug:
  ...
  SystemView for STM32F103ZE as target device and SWD at
