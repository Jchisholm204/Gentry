...
/*********************************************************************
*
*       Configuration of communication to SystemView
*/
#ifndef   OS_SYSVIEW_ENABLE
  #define OS_SYSVIEW_ENABLE  0  // Disabled in order to save memory
#endif
...
#if (OS_SUPPORT_TRACE_API != 0) && (OS_SYSVIEW_ENABLE == 1)
