...
----------------------------------------------------------------------
File    : BSP.c
Purpose : BSP for Keil MCB4357 eval board
--------  END-OF-HEADER  ---------------------------------------------
*/
...
**********************************************************************
*/
#define LED0_MASK     (1uL << 24)
#define LED1_MASK     (1uL << 25)
#define LED_MASK_ALL  (LED0_MASK | LED1_MASK)

#define LPC_SCU_BASE  0x40086000
#define SCU_SFSPD_10  (*(volatile unsigned int *)(LPC_SCU_BASE + 0x06A8))  //  Pin configuration register for pin PD_10
#define SCU_SFSPD_11  (*(volatile unsigned int *)(LPC_SCU_BASE + 0x06AC))  //  Pin configuration register for pin PD_11
