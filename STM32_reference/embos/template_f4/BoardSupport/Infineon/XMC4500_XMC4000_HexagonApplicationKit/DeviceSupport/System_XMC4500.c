 ...
 *
 * @par
 * Infineon Technologies AG (Infineon) is supplying this software for use with Infineon뭩
 * microcontrollers.
 * This file can be freely distributed within development tools that are supporting such
 * microcontrollers.
...
/* Setup the WDT */
#if (WDT_SETUP == 1)
WDT->CTR &= (unsigned int)~WDTENB_nVal;
#endif
...
if (!(SCU_PLL->PLLSTAT & SCU_PLL_PLLSTAT_VCOLOCK_Msk)){
	...
	/* Setup Main PLL */
	   ...
	   SCU_PLL->PLLCON1 = ((SCU_PLL_K1DIV) | (SCU_PLL_NDIV<<8) | (SCU_PLL_K2DIV_STEP_1<<16) |(SCU_PLL_PDIV<<24));
     ...
     /* Stop SysTick Timer */
	   ...
	   /* Setup devider settings for main PLL */
	   SCU_PLL->PLLCON1 = ((SCU_PLL_K1DIV) | (SCU_PLL_NDIV<<8) | (SCU_PLL_K2DIV_STEP_2<<16) | (SCU_PLL_PDIV<<24));
     ...
     /* Stop SysTick Timer */
	   ...
	   /* Setup devider settings for main PLL */
	   SCU_PLL->PLLCON1 = ((SCU_PLL_K1DIV) | (SCU_PLL_NDIV<<8) | (SCU_PLL_K2DIV_STEP_3<<16) | (SCU_PLL_PDIV<<24));
