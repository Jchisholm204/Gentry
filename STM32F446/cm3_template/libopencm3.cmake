...
set_property(TARGET stm32f446 PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${libopencm3_SOURCE_DIR}/include)
set_property(TARGET stm32f446 PROPERTY IMPORTED_LOCATION ${libopencm3_SOURCE_DIR}/lib/libopencm3_stm32f4.a)
add_dependencies(stm32f446 libopencm3)
target_link_directories(stm32f446 INTERFACE ${libopencm3_SOURCE_DIR}/lib)
